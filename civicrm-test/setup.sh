...
civicrm_version=`curl https://github.com/civicrm/civicrm-core/tags --silent | grep "/civicrm/civicrm-core/releases/tag/" | grep -v '.0">' | head -n 1 | awk -F'"' '{print $2}' | awk -F'/' '{print $NF}'`
